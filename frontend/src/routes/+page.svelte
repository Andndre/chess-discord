...
<svelte:head>
  <title
    >Chassse Discord - Discord Bot to Play Chess with just a few steps</title
  >
  <meta
    name="description"
    content="Do You Play Chess? Well, I have a good news for you. This Discord Bot allows you to play
